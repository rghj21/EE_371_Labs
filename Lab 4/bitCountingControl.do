...
add wave -noupdate /bitCountingControl_testbench/dut/ctrl_output
add wave -noupdate /bitCountingControl_testbench/dut/currA
...
WaveRestoreCursors {{Cursor 1} {794 ps} 0}
